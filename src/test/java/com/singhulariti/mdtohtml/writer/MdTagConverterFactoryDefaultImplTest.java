...
public class MdTagConverterFactoryDefaultImplTest {
    ...
    public void testWritingHeading1() {
        ...
        assertEquals(expected, mdContentConversionOrchestrator.handleMdTag(new TextMarkdownContent("#", "Test Text")));
    }
    ...
    public void testWritingBlankLine() {
        String expected = "";
        assertEquals(expected, mdContentConversionOrchestrator.handleMdTag(new TextMarkdownContent("", "")));
    }

    @Test
    public void testWritingLink() {
        String expected = "<a href=\"https://www.example.com\">Link text</a>";
        assertEquals(expected, mdContentConversionOrchestrator.handleMdTag(new LinkMarkDownContent("", "https://www.example.com", "Link text")));
    }
}
